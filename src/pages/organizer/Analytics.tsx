...
const topEvents = [
  { name: 'Electric Garden', revenue: '$15,390', tickets: 342 },
  { name: 'Bass Sector Opening', revenue: '$8,505', tickets: 189 },
  { name: 'Summer Festival 2026', revenue: '$42,350', tickets: 847 },
];

const recentActivity = [
  { type: 'sale', text: 'New ticket sold for Electric Garden', time: '2 min ago' },
  { type: 'member', text: 'Sarah Chen joined the community', time: '15 min ago' },
  { type: 'sale', text: '3 tickets sold for Bass Sector Opening', time: '1 hour ago' },
  { type: 'event', text: 'NYE Countdown 2027 was created', time: '2 hours ago' },
];
    ...
    <DashboardLayout title="Analytics">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-400 text-sm mt-1">
          Track your community's performance
        </p>
      </div>
          ...
          <div className="space-y-4">
            {topEvents.map((event, i) => (
              <div key={event.name} className="flex items-center gap-4">
                ...
                <div className="text-lime font-semibold text-sm">{event.revenue}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <div className="bg-surface border border-white/5 p-6">
          ...
          <div className="mt-4 pt-4 border-t border-white/5">
            ...
            <div className="text-2xl font-display font-semibold text-lime">+248</div>
          </div>
        </div>
