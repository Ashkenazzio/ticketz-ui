...
export default function NotFound() {
  return (
    <div className="bg-dark min-h-screen text-white font-sans selection:bg-lime selection:text-black flex flex-col items-center justify-center p-6">
      {/* Large 404 */}
      ...
      <div className="flex flex-col sm:flex-row items-center gap-4">
        <Link
          to="/"
          className="flex items-center gap-2 bg-lime text-dark px-6 py-3 font-semibold uppercase text-sm tracking-wide hover:bg-limehover transition-colors"
        >
      ...
      <button
        ...
        className="mt-8 flex items-center gap-2 text-gray-500 hover:text-white text-sm uppercase tracking-wide transition-colors"
      >
      ...
      <div className="fixed inset-4 border-2 border-lime/10 pointer-events-none" />
    </div>
  );
}
